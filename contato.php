...
<html lang='pt-br'>
   <head>
       ...
       <link rel='stylesheet' href='./assets/css/style-contatenos.css'>
   ...
   <body>
     ...
     <main>
        ...
        <img src='./assets/img/suporte.png' class='imagem-suporte' alt='Imagem representando uma atendente de suporte para auxiliar em dúvidas.'>
