...
<html lang='pt-br'>
   <head>
       ...
       <link rel='stylesheet' href='styles/style-cadastrese1.css'>
   ...
   <body>
     ...
     <main>
       ...
       <section class='section-infos'> 
          <img class='imagem-experimente' src='app/photos/experiment.png' alt='Imagem representa as dúvidas, satisfações e insatisfações da relação cliente-empresa.'>
